...
func TestExecuteLSRA(t *testing.T) {
  mapper := new(mappers.NoMapper)
	...
	var test_table = []struct {
	  ...
	  {processor.Register{0x02}, 0x01, processor.FlagRegister{N: 0, Z: 0, C:0}},
	  {processor.Register{0x00}, 0x00, processor.FlagRegister{N: 0, Z: 1, C:0}},
	  {processor.Register{0x81}, 0x40, processor.FlagRegister{N: 0, Z: 0, C:1}},
	  {processor.Register{0x01}, 0x00, processor.FlagRegister{N: 0, Z: 1, C:1}},
	}
...
func TestExecuteLSRMEM(t *testing.T) {
  mapper := new(mappers.NoMapper)
	...
	var test_table = []struct {
	  ...
	  {addrValue{0x01, 0x00, 0x02}, 0x01, processor.FlagRegister{N: 0, Z: 0, C:0}},
	  {addrValue{0x02, 0x00, 0x00}, 0x00, processor.FlagRegister{N: 0, Z: 1, C:0}},
	  {addrValue{0x04, 0x00, 0x81}, 0x40, processor.FlagRegister{N: 0, Z: 0, C:1}},
	  {addrValue{0x05, 0x00, 0x01}, 0x00, processor.FlagRegister{N: 0, Z: 1, C:1}},
	}
...
func TestExecuteDECReg(t *testing.T) {
  mapper := new(mappers.NoMapper)
	...
	var test_table = []struct {
	  ...
	  {0x10, 0, 0x0F, processor.FlagRegister{N: 0, Z: 0}},
	  {0x01, 1, 0x00, processor.FlagRegister{N: 0, Z: 1}},
	  {0x00, 0, 0xFF, processor.FlagRegister{N: 1, Z: 0}},
	}
...
func TestExecuteDECMEM(t *testing.T) {
  mapper := new(mappers.NoMapper)
	...
	var test_table = []struct {
	  ...
	  {addrValue{0x01, 0x60, 0x10}, 0x0F, processor.FlagRegister{N: 0, Z: 0}},
	  {addrValue{0x01, 0x60, 0x01}, 0x00, processor.FlagRegister{N: 0, Z: 1}},
	  {addrValue{0x01, 0x60, 0x00}, 0xFF, processor.FlagRegister{N: 1, Z: 0}},
	}
